...
<div style="margin-top: 30px">
	<center><span style="font-size:20px;font-weight:Bold;"><?php echo $judule; ?></span>
		<br>
	...
	<div class="row">
		<?php
		echo form_open($linkdari . '/addvideo');
		?>
							...
							<div class="col-md-12">
								<select class="form-control" name="istandar" id="istandar">
									...
									<?php if ($this->session->userdata('sebagai')!=4 && !$this->session->userdata('a01')){?>
										<option <?php echo $sel_standar[2];?> value="<?php echo $this->session->userdata('npsn');?>">Standar Sekolah</option>
									<?php } ?>
								</select>
							</div>
						</div>
		...
		<input type="hidden" name="npsnsekolah" id="npsnsekolah" value="<?php echo $this->session->userdata('npsn');?>">
