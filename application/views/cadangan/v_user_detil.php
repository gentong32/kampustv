                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" disabled class="form-control"
								   ...
								   if ($userData['bimbel']==3) echo "; anggota Bimbel";?>'>
                        </div>
                    </div>
        ...
        <div class="col-md-5">
            <div class="well bp-component" style="background-color: #FFFFFF">
                <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
								...
								<label for="inputDefault" style="margin-left: 0px;">
									...
									- Tanggal Verifikator: <?php echo $tgl_verifikasi;?> <br></label>
								<?php }} ?>
                            </div>
                        </div>
                    ...
                    <div id="dkantor" style="display:<?php if ($userData['sebagai'] == 4) echo 'block';
                    else echo 'none'; ?>">
                        <legend>Data Kantor</legend>

                        <div class="form-group">
                            <label for="inputDefault" class="col-md-12 control-label">Bidang</label>
                            <div class="col-md-12">
                    ...
                    <input type="hidden" id="npsn" name="npsn" value="<?php echo $userData['npsn']; ?>"/>
                    <input type="hidden" id="nm_sekolah" name="nm_sekolah" value="<?php echo $userData['sekolah']; ?>"/>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <?php if ($userData['verifikator'] == 2) { ?>
                                ...
                                <?php } ?>
                                <button onclick="return gantikondisi(3)" type="submit" class="btn btn-primary">Setujui
                                    Menjadi Verifikator <?php
                                    if ($userData['sebagai'] == 1)
                                        echo 'Sekolah';
                                    else
                                        echo 'Fordorum';
                                    ?> [Aktif hingga 31 Des 2020]
                                </button>
                            <?php } ?>
                            ...
                            <!--                        --><?php //if ($userData['sebagai'] == 4 && $userData['verifikator'] == 0) {
                            ?>
                            <!--                            <button onclick="return gantikondisi(4)" type="submit" class="btn btn-primary">Jadikan-->
                            <!--                                Verifikator-->
                            <!--                            </button>-->
                            <!--                        --><?php //}
                            ?>
                            <!---->
                            <!--                        --><?php //if ($userData['sebagai'] == 4 && $userData['kontributor'] == 0) {
                            ?>
                            <!--                            <button onclick="return gantikondisi(5)" type="submit" class="btn btn-primary">Jadikan-->
                            <!--                                Kontributor-->
                            <!--                            </button>-->
                            <!--                        --><?php //}
                            ?>
							...
							<?php if ($userData['verifikator'] == 0) { ?>
								<button onclick="return gantikondisi(31)" type="submit" class="btn btn-primary">Jadikan
									Verifikator
								</button>
								<br><br>
							<?php } ?>
							<?php if ($userData['verifikator'] == 3) { ?>
								<button onclick="return gantikondisi(32)" type="submit" class="btn btn-primary">Batalkan
									Verifikator
								</button>
								<br><br>
							<?php } ?>
                            ...
                            <?php if ($this->session->userdata('a02') && $this->session->userdata('sebagai') != 4 ||
                                ...
                                <button onclick="return gantikondisi(5)" type="submit" class="btn btn-primary">Jadikan
									...
									<?php } ?>
							<?php if ($userData['kontributor'] == 3) {?>
                                <button onclick="return gantikondisi(4)" type="submit" class="btn btn-primary">Batalkan
                                    Kontributor
                                </button>
								<?php } ?>
                            <?php } ?>
...
<!--                            --><?php //echo "<br><br><br>OBJEK SEBAGAI:".$userData['statusbayar'];?>
							...
							<?php if ($this->session->userdata('a01') ||
								...
								<div>
									<br>
									<button onclick="return tampilubah();" id="tbubahsebagai" style="height: 33px;padding-left: 5px;padding-right: 5px;">Ubah Sebagai</button>
									...
									if ($userData['bimbel']==0)
										...
										echo "Keluarkan dari Bimbel";?></button>
									<br>
									<div id="dubahsebagai" style="display: none">
									Ubah status sebagai:<br>
									<select class="form-control" name="isebagaibaru" id="isebagaibaru">
