...
<!--			<div class="col-md-12" style="padding-bottom:10px">-->
<!--                <textarea --><?php //echo $cekreadonly; ?><!-- style="max-width:800px;width:100%;height:auto;margin:0;padding:0"-->
<!--													  type="text"-->
<!--													  class="form-control" id="isubjudul" name="isubjudul"-->
<!--													  maxlength="100">--><?php //echo $tsubjudul; ?><!--</textarea>-->
<!--			</div>-->
<!--		</div>-->
		...
		<div class="form-group" style="margin-top: 30px;">
			...
			<div class="col-md-12" style="padding-bottom:10px;width: 200px">
				<select <?php echo $cekdisabled; ?> class="form-control" name="iadalink" id="iadalink">
					<option <?php echo $sellink[1]; ?> value="">Tidak</option>
					<option <?php echo $sellink[2]; ?> value="ada link">Ya</option>
				</select>
		...
		?>">
			<div class="form-group" style="margin-left: 5px">
				<div class="col-md-12" style="padding-bottom:10px;width: 200px">
					<!--                                <span style="color: #3d773d;font-style:italic ">Klik tombol dibawah ini untuk mengubah foto. Kemudian "Terapkan" </span>-->
					<input style="display:block;margin-left: 20px;" type="file" name="file" id="file"
