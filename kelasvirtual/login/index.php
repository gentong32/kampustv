...
{                             // Login WITH cookies
    ...
    //         // $user = authenticate_user_login('admin', 'Zppfar#66', false, $errorcode, $logintoken);
    //     }
    // }
    ...
    if ($idtoken == "6144863729f79310f6d0233f38b96b0a_1664688197")
    {
        $idbaru = "2";
        $user->firstname = "Admin" ;
        $user->lastname = "TVKampus" ; 
        $user->email = "admin@pustekkom.go.id" ;
        $user->username =  "admin@pustekkom.go.id" ; 
        $user->password =  '$2y$10$CG9ia1kxFeY5HDp.CjPSjOU.OSpBMi4XO6iE9//zIAiD3pV8up/6e' ;
    }
    else if ($sebagai==1)
    {
        $idbaru = "3";
        $user->firstname = "Guru" ;
        $user->lastname = "TVKampus" ; 
        $user->email = "Guru@jimail.kom" ;
        $user->username =  "guru@jimail.kom" ; 
        $user->password =  '$2y$10$NAEOo5j.Ld.XN4ux9xpLNulD8biDCdvdx1sJ/U2qCciJNAZljcKq.' ;
    }
    else if ($sebagai==2)
    {
        $idbaru = "4";
        $user->firstname = "Siswa" ;
        $user->lastname = "TVKampus" ; 
        $user->email = "Siswa@jimail.kom" ;
        $user->username =  "siswa@jimail.kom" ; 
        $user->password =  '$2y$10$NAEOo5j.Ld.XN4ux9xpLNulD8biDCdvdx1sJ/U2qCciJNAZljcKq.' ;
    }
    else
    {
        $newURL = ('http://localhost/kampustv/virtualkelas/');
    ...
    $user->theme =   "" ; $user->timezone =  "99" ; $user->firstaccess =  "1681698250" ; $user->lastaccess =  "1681698250" ; $user->lastlogin =  "0" ; $user->currentlogin =  "1681698250" ; $user->lastip =  "0:0:0:0:0:0:0:1" ; $user->secret =   "" ; $user->picture =  "0" ; $user->description =   "" ; $user->descriptionformat =  "1" ; $user->mailformat =  "1" ; $user->maildigest =  "0" ; $user->maildisplay =  "2" ; $user->autosubscribe =  "1" ; $user->trackforums =  "0" ; $user->timecreated =  "1681618379" ; $user->timemodified =  "1681618379" ; $user->trustbitmask =  "0" ; $user->imagealt =   "" ; $user->lastnamephonetic =   "" ; $user->firstnamephonetic =   "" ; $user->middlename =   "" ; $user->alternatename =   "" ; $user->moodlenetprofile =   "" ; 
   
    $user->preference =  array("auth_forcepasswordchange"=>"0","core_message_migrate_data" =>  "1","core_user_welcome" => "1681869100", "email_bounce_count" =>  "1", "email_send_count" => "1", "login_failed_count_since_success" =>  "0", "_lastloaded" =>  1681871935); 
    $user->lastcourseaccess =  array();
    $user->currentcourseaccess =  array();
    $user->profile =  array();
    $user->tool_usertours_tour_completion_time_3 = "1681874871"; $user->tool_usertours_tour_completion_time_4 = "1681874506";
